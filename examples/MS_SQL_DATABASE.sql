...
CREATE TABLE master.dbo.dropdown_lookup_table (
	ID bigint NOT NULL,
	DEL bit NOT NULL,
	[TEXT] char(30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
);
...
CREATE TABLE master.dbo.root_table (
	...
	LINK varchar(2083) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	LINK_BUTTON varchar(2083) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[DATE] date NULL,
